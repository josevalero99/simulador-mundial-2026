...
export default function ScoreInput({ match }: ScoreInputProps) {
  ...
  const chip =
    'h-9 w-9 rounded-lg bg-white/5 text-center font-mono text-base font-bold text-[#f5f5f5] outline-none transition-colors focus:ring-2 focus:ring-[#E8B84B] [appearance:textfield] [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none'
